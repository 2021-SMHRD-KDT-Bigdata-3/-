                ...
                <ul class="list-unstyled ">
                    <li class="pb-3 textb" >
                        ...
                        <ul class="collapse show list-unstyled pl-3 action"  >
                            ...
                            <li><a class="text-decoration-none" href="category.jsp?genre=전략" style="color:black;">전략</a></li>
                            <li><a class="text-decoration-none" href="category.jsp?genre=어드벤쳐" style="color:black;">어드벤처 및 캐쥬얼</a></li>
                            <li><a class="text-decoration-none" href="category.jsp?genre=시뮬레이션" style="color:black;">시뮬레이션</a></li>
                            <li><a class="text-decoration-none" href="category.jsp?genre=스포츠 및 레이싱" style="color:black;">스포츠 및 레이싱</a></li>
                        </ul>
                    </li>
