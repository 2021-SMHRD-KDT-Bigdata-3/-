		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<ul class="list-unstyled ">
					<li class="pb-3 textb"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						href="category.jsp" style="color: black;"> 카테고리 </a>
						<ul class="collapse show list-unstyled pl-3 action">
							<li><a class="text-decoration-none" href="#"
								style="color: black;">액션</a></li>
							<li><a class="text-decoration-none" href="#"
								style="color: black;">RPG</a></li>
							<li><a class="text-decoration-none" href="#"
								style="color: black;">전략</a></li>
							<li><a class="text-decoration-none" href="#"
								style="color: black;">어드벤처 및 캐쥬얼</a></li>
							<li><a class="text-decoration-none" href="#"
								style="color: black;">시뮬레이션</a></li>
							<li><a class="text-decoration-none" href="#"
								style="color: black;">스포츠 및 레이싱</a></li>
						</ul></li>
				</ul>
			</div>
					...
					<table style="color: black; text-align: center;">
						...
						<%// 테이블을 보여줄대 행과 열을 테이블 길이만큼 만들어야하므로 for문 작성
							...
							//p*15~(p+1)*15
								...
								out.print("<ul class=\"list-unstyled d-flex justify-content-center mb-1\">");
								out.print("<li>");
								for(int j=0; j<dl.get(i).getScore();j++){
									out.print("<i class=\"text-warning fa fa-star\"></i>");
								}
								for(int j=0; j<5-dl.get(i).getScore(); j++){
